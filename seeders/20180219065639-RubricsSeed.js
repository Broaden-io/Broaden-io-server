...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Rubrics', [
              ...
              { name: "Full Stack Mobile Skills", iconName: 'stay_current_portrait', description: "Make School's rubric for assessing course performance in any course", userId: 10005, createdAt: new Date(), updatedAt: new Date(), id: 10001 },
