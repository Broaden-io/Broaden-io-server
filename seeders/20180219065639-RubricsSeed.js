...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Rubrics', [
              ...
              { name: "Internship & Job Readiness", iconName: 'work', description: "Make School's rubric for assessing competencies and readiness for getting a job/internship", userId: 10005, createdAt: new Date(), updatedAt: new Date(), id: 10002 },
              // { name: "Success Skills", iconName: 'wb_sunny', description: "Make School's rubric for assessing competencies for professional skills and best practices", userId: 10005, createdAt: new Date(), updatedAt: new Date(), id: 10003 },
